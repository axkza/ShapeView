...
public class ShapeModel {
    ...
    //             是否有默认触摸置灰的效果
    public boolean defaultTouch;
    //         字体颜色    按下字体颜色     unable字体颜色
    public int textColor, textTouchColor, textUnableColor;
    ...
    //         线条颜色      按下线条的颜色      unable时的线条颜色   线条宽度       虚线宽度          虚线间隙
    public int strokeColor, strokeTouchColor, strokeUnableColor, strokeWidth, strokeDashWidth, strokeDashGap;
